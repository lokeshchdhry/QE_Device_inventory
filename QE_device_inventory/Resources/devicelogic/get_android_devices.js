...
exports.get_android_device = function(){
		...
		var xhr = Ti.Network.createHTTPClient({
		    onload: function onLoad() {
		        ...
		        for (var i=0;i<JSONdata.devices.length;i++){
		        	...
		        	listSection.headerTitle=JSONdata.devices.length+" Android device/s found";	
	...
	var activity = get_android_device_win.activity;
	...
	get_android_device_win.add(listView);
	get_android_device_win.open({modal:true});	
};
